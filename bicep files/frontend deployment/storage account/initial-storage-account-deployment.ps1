...
az deployment group create -g "rg-resume-prod-uks-001" -f "C:\Users\lgoodchild-a\Documents\Cloud Resume Challenge v2\bicep files\frontend deployment\storage account\storage.bicep" -p "C:\Users\lgoodchild-a\Documents\Cloud Resume Challenge v2\bicep files\frontend deployment\storage account\storage-parameters.json"
...
git clone "https://github.com/liam-goodchild/Cloud-Resume-Challenge-v2.git" "C:\Users\lgoodchild-a\Documents\Cloud Resume Challenge v2\githubrepo"

# Uploading the frontend files to the $web container.
az storage blob upload-batch -d `$web -s "C:\Users\lgoodchild-a\Documents\Cloud Resume Challenge v2\githubrepo\code files\frontend code" --account-name "stresumeproduks001"