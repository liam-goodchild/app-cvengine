...
az deployment group create -g $ResourceGroup -f "C:\Users\lgoodchild-a\Documents\Cloud Resume Challenge v2\frontend\content delivery network\cdn.bicep" -p "C:\Users\lgoodchild-a\Documents\Cloud Resume Challenge v2\frontend\content delivery network\cdn-parameters.json"
